...
import br.com.example.spring.dto.LoginDTO;
import br.com.example.spring.dto.TokenDTO;
import br.com.example.spring.service.impl.TokenService;
...
@RestController
@RequestMapping("/auth")
public class AutenticacaoResource extends  BaseResource<TokenDTO> {
